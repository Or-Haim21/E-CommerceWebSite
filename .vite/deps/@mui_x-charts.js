import {
  NoSsr_default,
  Popper_default
} from "./chunk-NC6VKAQL.js";
import {
  Typography_default
} from "./chunk-XX6WKR3G.js";
import "./chunk-DVA4GL3Z.js";
import "./chunk-M75LNPJ5.js";
import {
  useTheme
} from "./chunk-YVXBGERR.js";
import {
  shouldForwardProp,
  useRtl
} from "./chunk-I5FNZ3JD.js";
import {
  useThemeProps
} from "./chunk-N5RN52HE.js";
import "./chunk-DLHZPC5J.js";
import {
  init_esm,
  init_ownerWindow,
  init_useControlled,
...
function computeValue({
  ...
  allAxis.forEach((eachAxis, axisIndex) => {
    ...
    const scale2 = getScale(scaleType, axisExtremums, zoomedRange).nice(rawTickNumber);
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React67.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React67.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
  ...
  return (0, import_jsx_runtime43.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime43.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime43.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime43.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
...
var BarChart = React75.forwardRef(function BarChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  });
  ...
  return (0, import_jsx_runtime48.jsxs)(ResponsiveChartContainer, _extends({
    ...
    children: [props.onAxisClick && (0, import_jsx_runtime48.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime48.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime48.jsxs)("g", _extends({}, clipPathGroupProps, {
...
var useStringInterpolator = (path2) => {
  ...
  const interpolator = React76.useMemo(() => memoryRef.previousPath ? string_default(memoryRef.previousPath, memoryRef.currentPath) : () => memoryRef.currentPath, [memoryRef.currentPath, memoryRef.previousPath]);
  return interpolator;
};
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime49.jsxs)(React77.Fragment, {
    children: [(0, import_jsx_runtime49.jsx)("clipPath", {
      id: clipId,
      children: transitionAppear((style) => (0, import_jsx_runtime49.jsx)(animated.rect, {
        x: 0,
        y: 0,
      ...
      clipPath: `url(#${clipId})`,
      children: transitionChange((style, interpolator) => (0, import_jsx_runtime49.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime52.jsxs)(React80.Fragment, {
    children: [(0, import_jsx_runtime52.jsx)("clipPath", {
      id: clipId,
      children: transitionAppear((style) => (0, import_jsx_runtime52.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: style.animatedWidth,
        height: top + height + bottom
      ...
      clipPath: `url(#${clipId})`,
      children: transitionChange((style, interpolator) => (0, import_jsx_runtime52.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: style.value.to(interpolator)
      })))
    })]
...
var _excluded32 = ["x", "y", "id", "classes", "color", "dataIndex", "onClick", "skipAnimation", "shape"];
function CircleMarkElement(props) {
  ...
  if (shape !== "circle") {
    warnOnce2([`MUI X: The mark element of your line chart have shape "${shape}" which is not supported when using \`experimentalRendering=true\`.`, 'Only "circle" are supported with `experimentalRendering`.'].join("\n"), "error");
  }
  const theme = useTheme();
  const getInteractionItemProps = useInteractionItemProps();
  const {
  ...
  const classes = useUtilityClasses11(ownerState);
  return (0, import_jsx_runtime56.jsx)(animated.circle, _extends({}, other, {
    cx: position.x,
    cy: position.y,
    r: 5,
    fill: (theme.vars || theme).palette.background.paper,
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime57.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime57.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime58.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
  ...
  return (0, import_jsx_runtime59.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime59.jsx)(Element, _extends({
          id: seriesId,
...
var LineChart = React88.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
  });
  ...
  return (0, import_jsx_runtime60.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime60.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime60.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime60.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime60.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime60.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime60.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime60.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime60.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime60.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime60.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime60.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime60.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime60.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime60.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
...
function PieArc(props) {
  ...
  const getInteractionItemProps = useInteractionItemProps();
  return (0, import_jsx_runtime61.jsx)(PieArcRoot, _extends({
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React90.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime62.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime62.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime63.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime64.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime64.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PiePlot(props) {
  ...
  const {
    ...
    width,
    height
  } = React94.useContext(DrawingContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime65.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime65.jsx)("g", {
        ...
        children: (0, import_jsx_runtime65.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime65.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime65.jsx)(PieArcLabelPlot, {
          innerRadius,
...
var PieChart = React95.forwardRef(function PieChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPieChart"
  });
  ...
  return (0, import_jsx_runtime66.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ...
    onHighlightChange,
    className,
    children: [(0, import_jsx_runtime66.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime66.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime66.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
    }), (0, import_jsx_runtime66.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime66.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime66.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  }));
...
function Scatter(props) {
  ...
  } = React96.useContext(InteractionContext);
  ...
  const cleanData = React96.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
    const temp = [];
  ...
  return (0, import_jsx_runtime67.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime67.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
function ScatterPlot(props) {
  ...
  return (0, import_jsx_runtime68.jsx)(React97.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
...
var ScatterChart = React98.forwardRef(function ScatterChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
  ...
  return (0, import_jsx_runtime69.jsx)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: (0, import_jsx_runtime69.jsxs)(ZAxisContextProvider, _extends({}, zAxisProps, {
      children: [!props.disableVoronoi && (0, import_jsx_runtime69.jsx)(ChartsVoronoiHandler, _extends({}, voronoiHandlerProps)), (0, import_jsx_runtime69.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime69.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime69.jsx)("g", {
        "data-drawing-container": true,
        children: (0, import_jsx_runtime69.jsx)(ScatterPlot, _extends({}, scatterPlotProps))
      }), (0, import_jsx_runtime69.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime69.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime69.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), !props.loading && (0, import_jsx_runtime69.jsx)(ChartsTooltip, _extends({}, tooltipProps)), children]
    }))
  }));
});
...
var SparkLineChart = React99.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    width,
  ...
  return (0, import_jsx_runtime70.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime70.jsx)(BarPlot, {
      skipAnimation: true,
      slots,
      slotProps,
      sx: {
    ...
    }), plotType === "line" && (0, import_jsx_runtime70.jsxs)(React99.Fragment, {
      children: [(0, import_jsx_runtime70.jsx)(AreaPlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime70.jsx)(LinePlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime70.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime70.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime70.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  }));
...
var GaugeContext = React100.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function useGaugeState() {
  return React100.useContext(GaugeContext);
}
...
var GaugeContainer = React101.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
  ...
  const svgRef = React101.useRef(null);
  const chartSurfaceRef = useForkRef(ref, svgRef);
...
var Gauge = React105.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className
  ...
  return (0, import_jsx_runtime76.jsxs)(GaugeContainer, _extends({}, other, {
